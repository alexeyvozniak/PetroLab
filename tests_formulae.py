...
# Derived freshness is source-content based for new formula rows. A refresh is allowed
# to touch technical timestamps without invalidating an unchanged scientific row.

...
feo_result = calculate_formula_safe(feo_basis, "olivine", "ol_4o_fe2").data.iloc[0]
fe2o3_result = calculate_formula_safe(fe2o3_basis, "olivine", "ol_4o_fe2").data.iloc[0]
...
with tempfile.TemporaryDirectory(prefix="petrolab_derived_") as tmp:

...
def run() -> None:
    ...
    del dataframe, first, second, refreshed, row_a1, row_a2, protected_before, protected_after
    del initial, reordered, without_second, export_records, related_first, related_second
    gc.collect()

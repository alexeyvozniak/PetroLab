...
def main() -> None:
    ...
    assert by_name["analcime"].chemical_target == "analcime"
    ...
    examples = pd.DataFrame([
        ...
        {"truth_target": "plagioclase", "SiO2": 68.7, "Al2O3": 19.4, "Na2O": 11.8, "CaO": 0.1, "K2O": 0.1},
        {"truth_target": "analcime", "SiO2": 61.02, "Al2O3": 24.67, "Na2O": 14.12, "K2O": 0.17, "CaO": 0.02, "FeO": 0.0, "MgO": 0.0},
    ...
    # Extreme K-rich, very low-Al historical analyses can overlap olivine-like Si-Mg-Fe totals.
    # The recognizer must not force such a composition to olivine with high confidence.
    low_al_k_rich = recognize_mineral({
        "SiO2": 43.07, "Al2O3": 0.55, "FeO": 18.05, "MgO": 27.04,
        "K2O": 10.63, "Na2O": 0.19, "CaO": 0.03, "TiO2": 0.22,
    })
    assert low_al_k_rich.target != "olivine" or low_al_k_rich.confidence != "high"

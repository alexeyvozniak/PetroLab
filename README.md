...
- Шлифы и поля: лёгкое превью тяжёлого оригинала, препараты, прямоугольные/квадратные поля по двум углам и пространственные метки, связывающие одну позицию с отдельными EPMA/EDS/LA-ICP-MS результатами без их смешения; малый BSE привязывается к одному полю.

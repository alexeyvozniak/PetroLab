...
MINERAL_REFERENCE_VERSION = "2026.08.2"
REFERENCE_NOTE = (
...
MINERALS: tuple[MineralReference, ...] = (
    ...
    MineralReference("analcime", "feldspathoid", "analcime", "Na(AlSi2O6)·H2O", "group", "Hydration and symmetry require structural/context evidence; the chemical target is conservative."),

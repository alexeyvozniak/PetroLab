...
def render_home_dashboard_page() -> None:
    ...
    render_section_header("Что делать сейчас", "Начните с объекта или откройте любой специальный инструмент напрямую")
    actions = [
        ("01 · Рабочий стол", "Открыть один Sample или массив вместе со всеми связанными данными", "workspace"),
        ...
        ("04 · Рабочий процесс", "Пройти выбранный набор от контекста до первых графиков", "workflow"),
    ]
    cols = st.columns(4)

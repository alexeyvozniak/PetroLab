...
ROUTE_TARGETS: dict[str, tuple[str, str]] = {
    ...
    "samples": ("petrolab.ui.pages.database_browser", "render_database_browser_page"),
    "database": ("petrolab.ui.pages.database_browser", "render_database_browser_page"),
    ...
    "export": ("petrolab.ui.pages.export", "render_export_page"),
